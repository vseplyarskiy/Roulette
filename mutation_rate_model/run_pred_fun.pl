...
#open (IN,"gunzip -c /net/home/vseplyarsky/GNOMAD_Tufts/mut_model/for_LASSO/$chr\_input.gz|")||die;
open (IN,"/net/home/vseplyarsky/GNOMAD_Tufts/mut_model/for_LASSO/$chr\_input")||die;
my $h;
while (<IN>){
    chomp;
    $h++;
...
#    print "DOWN $out $in\n";
 ...
 #   print "$v $h\n\n\n";
    ...
    $mut="$mut\_$mutd";
    my $mut1=&rvc($mut);
    print OUT "$a[0] $mut/$mut1 $v $lam $a[13]\n";
